...
const SignUp = () => {
  ...
  return <>
    <section dir={`${crrentLanguage === "ar" ? "rtl" : "ltr"}`} className="signup  ">
      <div className={`container   shadow-lg rounded-3 w-50 `}   >
        ...
        <form onSubmit={formik.handleSubmit}  >
          ...
          <label className="pt-1  fw-medium" htmlFor="name">{t("name")}</label>
          ...
          <label className="pt-1  fw-medium" htmlFor="email">{t("email")}</label>
          ...
          <label className="pt-1  fw-medium" htmlFor="password">{t("password")}</label>
          ...
          <label className="pt-1  fw-medium" htmlFor="rePassword">{t("rePassword")}</label>
          ...
          <label className="pt-1 fw-medium" htmlFor="phone">{t("phone")}</label>
          ...
          {check === "true" ? <button type="submit" disabled={!(formik.dirty && formik.isValid)} className="signupBtn  shadow  py-2 disabled mt-4 mb-1 ">
            ...
            : <button type="submit" disabled={!(formik.dirty && formik.isValid)} className="signupBtn mt-2  shadow disabled  mb-1 ">{t("signUp")}</button>
